...
def init_db():
    ...
    ("Nuevo logotipo / isotipo / imagotipo / isologo", None, None, None),
    ("Rediseño Identidad Corporativa", 1480, 890, 520),
    ("Rediseño logotipo / isotipo / imagotipo / isologo", None, None, None),
    ("Restyling Identidad Corporativa", 1030, 660, 370),
    ("Restyling logotipo / isotipo / imagotipo / isologo", None, None, None),
    ...
    ("Papelería comercial", 660, 520, 360),
    ("Tarjetas personales", 120, 80, 60),
    ...
    ("Postal", 130, 80, 50),
    ("Volante / Flyer solo frente", 140, 100, 70),
